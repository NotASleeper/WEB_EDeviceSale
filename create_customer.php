...
<body>
    ...
    <!-- section create_new_customer starts -->
    <section class="user-profile">
        ...
        <div class="profile-header">
            ...
            <p class="header-title">Create new User profile <br> <span>Customer</span></p>
        </div>
        <form action="" id="form-c-gadget" method="POST" enctype="multipart/form-data" class="profile-body">
            <div class="panel">
                ...
                <div class="profile-item">
                    ...
                    <input name="phone_no" placeholder="Phone Number" maxlength="10" required value="">
                </div>
            </div>
            <div class="panel">
